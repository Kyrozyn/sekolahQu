...
@section('content')
        <div class="row">
            <div class="col-md-9" style="display: block;margin-left: auto;margin-right: auto;width: auto">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>NIS</th><th>Nama</th><th>Tempat Lahir</th><th>Tanggal Lahir</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($siswa as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->NIS }}</td><td>{{ $item->nama }}</td><td>{{ $item->tempat_lahir }}</td><td>{{ $item->tanggal_lahir }}</td>
                                        <td>
                                            <a href="{{ url('/dashboard/siswa/' . $item->id) }}" title="View siswa"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
